...
export const T = {
  ...
  bpStep1Q: { ru: 'Кто едет?', en: 'Who is riding?', de: 'Wer fährt?', fr: 'Qui roule ?', es: '¿Quién conduce?', th: 'ใครขับ?' },
  bpSolo: { ru: 'Один / одна', en: 'Solo', de: 'Allein', fr: 'Seul(e)', es: 'Solo/a', th: 'คนเดียว' },
  bpSoloDesc: { ru: 'Еду самостоятельно', en: 'Riding alone', de: 'Fahre allein', fr: 'Je roule seul(e)', es: 'Voy solo/a', th: 'ขับคนเดียว' },
  bpCouple: { ru: 'Двое взрослых', en: 'Two adults', de: 'Zwei Erwachsene', fr: 'Deux adultes', es: 'Dos adultos', th: 'สองคน' },
  bpCoupleDesc: { ru: 'Едем вдвоём', en: 'Riding together', de: 'Fahren zu zweit', fr: 'On roule à deux', es: 'Vamos juntos', th: 'ขับด้วยกัน' },
  bpChild: { ru: 'С ребёнком', en: 'With a child', de: 'Mit Kind', fr: 'Avec un enfant', es: 'Con niño', th: 'มีเด็ก' },
  bpChildDesc: { ru: 'Нужно устойчиво и безопасно', en: 'Need stability and safety', de: 'Brauche Stabilität und Sicherheit', fr: 'Besoin de stabilité et sécurité', es: 'Necesito estabilidad y seguridad', th: 'ต้องมั่นคงและปลอดภัย' },
  bpGirl: { ru: 'Девушка', en: 'Girl', de: 'Mädchen', fr: 'Fille', es: 'Chica', th: 'ผู้หญิง' },
  bpGirlDesc: { ru: 'Хочу лёгкий и красивый', en: 'Want light and pretty', de: 'Leicht und hübsch gewünscht', fr: 'Je veux léger et joli', es: 'Quiero ligero y bonito', th: 'อยากได้เบาและสวย' },
  bpStep2Q: { ru: 'Опыт вождения?', en: 'Riding experience?', de: 'Fahrerfahrung?', fr: 'Expérience de conduite ?', es: '¿Experiencia conduciendo?', th: 'ประสบการณ์ขับขี่?' },
  bpNewbie: { ru: 'Первый раз', en: 'First time', de: 'Erstes Mal', fr: 'Première fois', es: 'Primera vez', th: 'ครั้งแรก' },
  bpNewbieDesc: { ru: 'Никогда не ездил(а) на мото', en: 'Never ridden a motorbike', de: 'Noch nie Motorrad gefahren', fr: 'Jamais conduit de moto', es: 'Nunca he montado en moto', th: 'ไม่เคยขับมอเตอร์ไซค์' },
  bpBeginner: { ru: 'Немного умею', en: 'Some experience', de: 'Etwas Erfahrung', fr: 'Un peu d\'expérience', es: 'Algo de experiencia', th: 'พอขับได้บ้าง' },
  bpBeginnerDesc: { ru: 'Ездил(а) пару раз, не уверен(а)', en: 'Ridden a few times, not confident', de: 'Ein paar Mal gefahren, unsicher', fr: 'Conduit quelques fois, pas sûr(e)', es: 'Unas pocas veces, sin confianza', th: 'เคยขับบ้าง ยังไม่มั่นใจ' },
  bpConfident: { ru: 'Уверенно езжу', en: 'Confident rider', de: 'Sicherer Fahrer', fr: 'Conducteur confiant', es: 'Conduzco con confianza', th: 'ขับได้มั่นใจ' },
  bpConfidentDesc: { ru: 'Скутер или мото — без проблем', en: 'Scooter or motorbike — no problem', de: 'Roller oder Motorrad — kein Problem', fr: 'Scooter ou moto — pas de problème', es: 'Scooter o moto — sin problema', th: 'สกู๊ตเตอร์หรือมอเตอร์ไซค์ — ไม่มีปัญหา' },
  bpExpert: { ru: 'Опытный', en: 'Experienced', de: 'Erfahren', fr: 'Expérimenté', es: 'Experimentado', th: 'มีประสบการณ์' },
  bpExpertDesc: { ru: 'Езжу давно, хочу что-то интересное', en: 'Riding for years, want something exciting', de: 'Fahre seit Jahren, will was Spannendes', fr: 'Je roule depuis longtemps, envie de sensations', es: 'Conduzco hace años, quiero algo emocionante', th: 'ขับมานาน อยากได้อะไรท้าทาย' },
  bpStep3Q: { ru: 'Тип байка?', en: 'Bike type?', de: 'Bike-Typ?', fr: 'Type de moto ?', es: '¿Tipo de moto?', th: 'ประเภทรถ?' },
  bpAutoOnly: { ru: 'Только скутер-автомат', en: 'Automatic scooter only', de: 'Nur Automatik-Roller', fr: 'Scooter automatique uniquement', es: 'Solo scooter automático', th: 'สกู๊ตเตอร์ออโต้เท่านั้น' },
  bpAutoOnlyDesc: { ru: 'Просто и удобно, без передач', en: 'Simple and easy, no gears', de: 'Einfach und bequem, ohne Schalten', fr: 'Simple et facile, sans vitesses', es: 'Simple y fácil, sin marchas', th: 'ง่ายและสะดวก ไม่ต้องเปลี่ยนเกียร์' },
  bpManualOk: { ru: 'Готов к мотоциклу', en: 'Ready for motorcycle', de: 'Bereit fürs Motorrad', fr: 'Prêt pour la moto', es: 'Listo para moto', th: 'พร้อมขับมอเตอร์ไซค์' },
  bpManualOkDesc: { ru: 'Механика не пугает', en: 'Manual doesn\'t scare me', de: 'Schaltung schreckt mich nicht', fr: 'La manuelle ne me fait pas peur', es: 'La manual no me asusta', th: 'เกียร์ธรรมดาไม่กลัว' },
  bpStep4Q: { ru: 'Что важнее?', en: 'What matters most?', de: 'Was ist wichtiger?', fr: 'Qu\'est-ce qui compte ?', es: '¿Qué es más importante?', th: 'อะไรสำคัญที่สุด?' },
  ...
  bpStep5Q: { ru: 'Куда планируете ездить?', en: 'Where do you plan to ride?', de: 'Wohin willst du fahren?', fr: 'Où comptez-vous rouler ?', es: '¿Adónde planeas ir?', th: 'วางแผนขับไปไหน?' },
  ...
  bpStep6Q: { ru: 'Срок и бюджет', en: 'Duration and budget', de: 'Dauer und Budget', fr: 'Durée et budget', es: 'Duración y presupuesto', th: 'ระยะเวลาและงบประมาณ' },
