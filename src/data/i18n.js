...
export const T = {
  ...
  bestDeal: { ru: 'Лучшее предложение', en: 'Best deal', de: 'Bestes Angebot', fr: 'Meilleure offre', es: 'Mejor oferta', th: 'ข้อเสนอที่ดีที่สุด' },
  ...
  bpcTitle: { ru: 'Не знаете какой выбрать?', en: 'Not sure which to pick?', de: 'Nicht sicher, welches?', fr: 'Quel scooter choisir ?', es: '¿No sabes cuál elegir?', th: 'ไม่แน่ใจว่าจะเลือกรุ่นไหน?' },
  ...
  bpcBtn: { ru: 'Подобрать', en: 'Find bike', de: 'Finden', fr: 'Trouver', es: 'Encontrar', th: 'ค้นหา' },
