...
export const T = {
  // ── SEO Meta ──
  seoTitle: {
    ru: 'ThaiGo Lite — Аренда байков на Пхукете | от 180 ฿/день',
  ...
  seoDescription: {
    ru: 'Аренда байков и скутеров на Пхукете без залога паспорта. Honda Scoopy от 180 ฿/сутки. Доставка в отель, договор и страховка.',
